...
%
classdef ExactSystemModel < Reconstruct.Recon.SysModel.SystemModel
    properties
        vox;
        traj;
        isDFT = true;
    ...
    methods
        ...
        function obj = ExactSystemModel(traj, overgridFactor, imageSize, verbosity)
            ...
            obj = obj@Reconstruct.Recon.SysModel.SystemModel(overgridFactor, imageSize, [], verbosity);
        ...
        function c = mtimes(obj,b)
            if ~isa(obj, 'Reconstruct.Recon.SysModel.ExactSystemModel')
