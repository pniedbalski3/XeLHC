...
%
classdef L2Proximity < Reconstruct.Recon.SysModel.Proximity.Proximity
	methods
		function obj = L2Proximity(kernelObj, verbosity)
			% Call super constructor to build obj
			obj = obj@Reconstruct.Recon.SysModel.Proximity.Proximity(kernelObj, verbosity);
		...
		function [sample_idx,voxel_idx,kernel_vals] = ...
			...
			[sample_idx,voxel_idx,preovergrid_distances] = ...
				Reconstruct.Recon.SysModel.Proximity.sparse_gridding_distance_mex(traj',...
