...
%
classdef MatrixSystemModel < Reconstruct.Recon.SysModel.SystemModel
    properties
        A;
        ATrans;
        supersparse;
    ...
    methods
        ...
        function obj = MatrixSystemModel(traj, overgridFactor, imageSize, proximityObj, ...
            ...
            obj = obj@Reconstruct.Recon.SysModel.SystemModel(overgridFactor, imageSize, proximityObj, verbosity);
