classdef ConjugateGradient < Reconstruct.Recon.ReconModel.GriddedReconModel
    properties
        iterations;
        weights;
    end
    methods
        function obj = ConjugateGradient(system_model, iter, verbose)
            ...
            obj = obj@Reconstruct.Recon.ReconModel.GriddedReconModel(system_model, verbose);
        ...
        function gridVol = grid(obj, data, traj, varargin)
            ...
            if(isa(obj.system,'Reconstruct.Recon.SysModel.MatrixSystemModel') )
