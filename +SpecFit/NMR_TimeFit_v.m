...
%             ci = nlparci(fit_params,residual,'jacobian',J);
        ...
        function ax1 = plotTimeAndSpectralFit(obj)
            ...
            title('Spectrum (Magnitude)') %PJN - Give a title
            %PJN add a legend
            ...
            title('Spectrum (Real)') %PJN - Give a title
            %PJN add a legend
            legend('Data','Fit','Residual')
...
%             legend('Measured','Fitted','Residual');
            ...
            title('Spectrum (Imaginary)') %PJN - Give a title
            %PJN add a legend
            legend('Data','Fit','Residual')
...
%             legend(legendStrings);
            ...
            ylabel('Magnitude Intensity');
            set(ax4,'xticklabel',{[]}) ;
            title('Time Domain (Magnitude)') %PJN - Give a title
            %PJN add a legend
            legend('Data','Fit','Residual')
            ...
            ylabel('Real Intensity');
            set(ax6,'xticklabel',{[]});
            title('Time Domain (Real)') %PJN - Give a title
            %PJN add a legend
            legend('Data','Fit','Residual')
            ...
            xlabel('Time');
            ylabel('Imaginary Intensity');
            title('Time Domain (Imaginary)') %PJN - Give a title
            %PJN add a legend
            legend('Data','Fit','Residual')
